...
class populate_tables:
    ...
    def run(self):
        ...
        try:
            commands = """INSERT ALL
INTO thelanguage (LANGUAGE_ID, THELANGUAGE) VALUES (1, 'English')
...
INSERT ALL
INTO genre(GENRE_ID, GENRE)  VALUES  (1, 'Comedy')
...
INSERT ALL
INTO director(DIRECTOR_ID, FIRST_NAME, LAST_NAME, NATIONALITY, DIRECTOR_DESCRIPTION, DATE_OF_BIRTH) VALUES (0, 'John', 'Dars', 'USA', 'Visionary maestro of laughter, crafting comedic masterpieces that tickle the funny bone and warm the heart.', TO_DATE('1970-01-01', 'YYYY-MM-DD'))
...
INSERT ALL
INTO productioncompany(COMPANY_ID, COMPANY_NAME, FILMSTYLE_INFO, MOVIES) VALUES (5, 'Cinematic Creations', 'Specializing in visually stunning and emotionally resonant films', 'Laugh Fest')
...
(2, 'Laugh Fest', 'USA', 144, 25.99, 'HD', TO_DATE('2023-11-15', 'YYYY-MM-DD'), 4.5, 'A hilarious comedy for all ages', 1, 0, 1, 5)
INTO movie(movie_id, title, country_origin, runtime, thecost, video_format, release_date, rating, movie_description, genre_id, director_id, language_id, company_id) VALUES 
...
INSERT ALL 
INTO theUser (USER_ID, USERNAME, FNAME, LNAME, CURRENT_POINTS, EMAIL, DATE_OF_BIRTH, PASSKEY) VALUES (1, 'john_doe', 'John', 'Doe', 150, 'john.doe@example.com', TO_DATE('1992-05-15', 'YYYY-MM-DD'), 'securepassword123')
...
INSERT ALL
INTO billing(TRANSACTION_ID, BILL_DATE, USERNAME, EMAIL, ORDER_TOTAL, PAYMENT_METHOD, USER_ID) VALUES (1, TO_DATE('2023-09-30', 'YYYY-MM-DD'), 'john_doe', 'john.doe@example.com', 25.99, 'Credit Card', 1)
